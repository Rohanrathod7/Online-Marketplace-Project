    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Toys', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('Process', 'Processing'), ('Shipping', 'Shipping'), ('delivered', 'Delivered')], default='Processing', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='Fresh Cookies', max_length=100)),
                ...
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=4, max_length=20, prefix='sku', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Rohan', max_length=100)),
                ...
                ('address', models.CharField(default='Pune Pimpri', max_length=100)),
                ('contact', models.CharField(default='(91)+987654321', max_length=100)),
